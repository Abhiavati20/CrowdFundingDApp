  ...
  return (
    <div>
      ...
      <div className="w-full flex md:flex-row flex-col mt-10 gap-[30px]">
        ...
        <div className="flex md:w-[150px] w-full flex-wrap justify-betweeb gap-[30px]">
            <CountBox title="Days Left" value={remainingDays} />
            <CountBox title={`Raised of ${state.target}`} value={state.amountCollected} />
            <CountBox title="Total Backed us" value={donators.length} />
        </div>
        ...
        <div className="flex-[2] flex flex-col gap-[40px]">
          ...
          <div className="mt-[20px] flex flex-row items-center flex-wrap gap-[14px]">
            ...
            <div>
              ...
              <p className="mt-[4px] font-epilogue font-normal text-[12px] text-[#808191]">1 campaigns</p>
            </div>
          </div>
