  ...
  return (
    <div className="flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6">
      ...
      <div className="sm:flex hidden flex-row justify-end items-center gap-4">
        ...
        <Link to="/profile">
          <div className="w-[52px] h-[52px] rounded-full bg-[#2c2f32] flex justify-center items-center cursor-pointer">
            <img src={thirdweb} alt="third web" className="w-[60%] h-[60%] object-contain" />
          </div>
        </Link>
      ...
      <div className="sm:hidden flex justify-between items-center relative">
        <div div className="w-[40px] h-[40px] rounded-[10px] bg-[#2c2f32] flex justify-center items-center cursor-pointer">
          <img src={logo} alt="third web" className="w-[60%] h-[60%] object-contain" />
        </div>
